...
template <class Object>
int binarySearch(const vector<Object>& arr, const string& target) {
    int left = 0;
...
int main(){
    ...
    for(int p = 0 ; p < copyinputwords.size(); p ++){
    ...
    */
    ...
    cout << "Speed Up Insertion Sort/Quick Sort(Median): " << static_cast<double>(is) / qsm << endl;
